...
class WindowFunctionExecutor : public AbstractExecutor {
 ...
 private:
  ...
  //                   const std::unordered_set<uint32_t> &function_column_idx_set, WindowFunctionType
  //                   win_function_type, const std::vector<std::pair<OrderByType, AbstractExpressionRef>> &order_bys,
